                ...
                <div class="modal-content form-elegant">
                  ...
                  <div class="modal-body mx-4">
                    ...
                    <div class="text-center my-3">
                      <button type="button" class="btn btn-outline-dark btn-block btn-rounded z-depth-1a">Login</button>
                    </div>
                  </div>
                  <!--Footer-->
                  <div style="justify-content: center!important;" class="modal-footer mx-5 pt-3 mb-1">
                    <p class="font-small grey-text d-flex">Belum punya akun? <a href="#" class="blue-text ml-1">Daftar disini</a></p>
                  </div>
                </div>
                <!--/.Content-->
              </div>
